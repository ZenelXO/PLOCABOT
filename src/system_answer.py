...
# Ejemplo de uso
# pregunta = "Cuantos barcos hubieron en total en rada sur lp, la semana pasada?"
# contexto = "{'Industrial Ship': 200, 'Cruise Ship': 0, 'Sailboat': 1, 'Human Powered Boat': 0, 'Motorboat': 8}"
